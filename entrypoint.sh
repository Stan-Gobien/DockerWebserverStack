...
curl -o  /bin/entrypoint.sh https://raw.githubusercontent.com/Stan-Gobien/DockerWebserverStack/cloud01/entrypoint.sh --no-progress-meter
curl -o  /bin/dependencies.sh https://raw.githubusercontent.com/Stan-Gobien/DockerWebserverStack/cloud01/dependencies.sh --no-progress-meter
